...
//        if(!orderIdText.matches("^[a-zA-Z][a-zA-Z]*$"))
        ...
        //Open PaymentGUI and pass the order ID
        java.awt.EventQueue.invokeLater(() -> {
            ...
            //auto-click the Load Order button
...
public void addMealIfExists(String mealName, int quantity) {
    String fileName = "meals.txt";  // اسم الفايل اللي فيه الوجبات
